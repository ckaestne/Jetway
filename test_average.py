...
if(vcodec == 1):
	...
	for x in range(0, 512):
		...
		command = command + output # Adding output to the command
		...
		while gline:
			...
			gline = g.readline()
		subprocess.call("echo " + str( ftotal / fcount) + " >> CPU_average.txt", shell=True)
		subprocess.call("echo " + str( gtotal / gcount) + " >> power_average.txt", shell=True)
